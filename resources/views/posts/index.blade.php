   ...
   @foreach ($posts as $post)
    <div class="row pt-5">
        <div class="col-6 offset-3">
            <a href="/p/{{$post->id}}"><img src="/storage/{{$post->image}}" class="img-fluid" alt="{{$post->caption}}"></a>
        </div>
    </div>
    <div class="row">
        <div class="col-6 offset-3 mt-4">
            <div class="heading d-flex align-items-center">
                ...
                <div class="p-0 font-weight-bold mr-2"><a class="text-dark" href="/profile/{{$post->user->id}}">{{$post->user->username}}</a></div>
